...
var staticAppList=[
        ...
        {id:1008,name:'复苏小龙',enabled:false,status:'开发中',imgSrc:'./app/img/app-fusu.png',version:'1.0',intro:'复苏小龙A100心肺复苏训练模拟人，可以直观反映心肺复苏操作对供血的影响，便携、易用，为普及CPR急救知识而生。',delete:false},
        {id:1009,name:'优尼克UniqueMan',enabled:false,status:'开发中',imgSrc:'./app/img/app-yunike.png',version:'3.0',intro:'优尼克UniqueMan综合仿生急救训练考核系统，是一款ALS高级生命支持训练的模拟人，通过真实的临床病例模拟，训练学生实操技能和临床思维能力。',delete:false},
        {id:1010,name:'智能分娩急救模拟人',enabled:false,status:'开发中',imgSrc:'./app/img/app-fm.png',version:'3.0',intro:'本系统以急救和分娩知识为主，涵盖妇科、儿科、产科、急救及护理等学科，通过临床病例模拟，培养学生操作技能和临床思维能力。',delete:false},
