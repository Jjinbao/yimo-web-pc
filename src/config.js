...
var staticAppList=[
        ...
        {id:1009,name:'优尼克UniqueMan',enabled:true,status:'添加',imgSrc:'./app/img/app-yunike.png',version:'3.0',intro:'优尼克UniqueMan综合仿生急救训练考核系统，是一款ALS高级生命支持训练的模拟人，通过真实的临床病例模拟，训练学生实操技能和临床思维能力。',delete:false},
